...
if __name__ == '__main__':
    ...
    parser.add_argument('--labels', type=str, default='F:/project/yolact/data/coco2017/annotations/person_keypoints_train2017.json', help='path to json with keypoints train labels')
