...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-images-folder', type=str, default='F:/project/yolact/data/coco2017/train2017/', help='path to COCO train images folder')
    ...
    parser.add_argument('--checkpoint-path', type=str, default='./ckpt/mobilenet_sgd_68.848.pth.tar', help='path to the checkpoint to continue training from')
    parser.add_argument('--from-mobilenet', type=bool,default=True,
    ...
    parser.add_argument('--val-images-folder', type=str, default='F:/project/yolact/data/coco2017/val2017/', help='path to COCO val images folder')
